...
public class MarksValidationTests
{
    ...
    [Fact]
    public async Task GradeSubmission_ShouldThrowException_WhenMarksAreNegative()
    {
        // Arrange
        using var context = DbContextMock.CreateInMemoryDbContext(nameof(GradeSubmission_ShouldThrowException_WhenMarksAreNegative));
        ...
        var submissionService = new SubmissionService(context);
        var gradeDto = new GradeSubmissionDto(Marks: -10, Feedback: "Negative marks!"); // -10 < 0
