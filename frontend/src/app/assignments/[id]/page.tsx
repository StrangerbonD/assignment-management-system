                      ...
                      <td style={{ maxWidth: '280px' }}>
                        ...
                        {s.fileUrl && (
                          <div style={{ marginTop: '0.3rem' }}>
                            {isImageFile(s.fileUrl) ? (
                              <a href={s.fileUrl} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm" style={{ fontSize: '0.75rem', padding: '0.2rem 0.5rem' }}>
                                Image File
                              </a>
                            ) : isPdfFile(s.fileUrl) ? (
                              <a href={s.fileUrl} target="_blank" rel="noreferrer" className="btn btn-secondary btn-sm" style={{ fontSize: '0.75rem', padding: '0.2rem 0.5rem' }}>
                              ...
                              <a href={s.fileUrl} target="_blank" rel="noreferrer" style={{ fontSize: '0.75rem', color: '#006633', textDecoration: 'underline' }}>
                                Open Link
                              </a>
                            )}
                          </div>
